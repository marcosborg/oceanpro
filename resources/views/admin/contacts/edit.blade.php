                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.contacts.update", [$contact->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('message') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control" name="message" id="message">{{ old('message', $contact->message) }}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('privacy') ? 'has-error' : '' }}">
                            <div>
                                <input type="checkbox" name="privacy" id="privacy" value="1" {{ $contact->privacy || old('privacy', 0) === 1 ? 'checked' : '' }} required>
