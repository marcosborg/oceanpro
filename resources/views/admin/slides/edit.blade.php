                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.slides.update", [$slide->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="title" id="title" value="{{ old('title', $slide->title) }}">
                            @if($errors->has('title'))
                        ...
                        <div class="form-group {{ $errors->has('subtitle') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="subtitle" id="subtitle" value="{{ old('subtitle', $slide->subtitle) }}">
                        ...
                        <div class="form-group {{ $errors->has('button') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="button" id="button" value="{{ old('button', $slide->button) }}">
                        ...
                        <div class="form-group {{ $errors->has('link') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="link" id="link" value="{{ old('link', $slide->link) }}">
                            @if($errors->has('link'))
                        ...
                        <div class="form-group {{ $errors->has('image') ? 'has-error' : '' }}">
                            <label class="required" for="image">{{ trans('cruds.slide.fields.image') }}</label>
